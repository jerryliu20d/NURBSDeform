...
from NURBS_surface import Surface, SurfaceFactory
...
class TopologyFactory:
    ...
    def create_shape_object(self,shape):
        ...
        if self.shape_type == "Surface":
            surf = SurfaceFactory()
            return surf.create_surface_object(shape, self.shape_type)
    ...
    def parse_shape(self, prefix):
        ...
        for face_idx, subshape in enumerate(t.faces()):
            ...
            if surface is not None:
                ...
                surface.dump_data(prefix, face_idx)
